...
if __name__ == '__main__':
    ...
    envs = [
        ...
        {
            'env': environments.get_small_no_slip_frozen_lake_environment(),
            'name': 'noslip_small_frozen_lake',
            'readable_name': 'Frozen Lake (4x4)',
        },
        {
            'env': environments.get_large_no_slip_frozen_lake_environment(),
            'name': 'noslip_large_frozen_lake',
            'readable_name': 'Frozen Lake (15x15)',
        },
        # {
        #     'env': environments.get_small_no_reward_frozen_lake_environment(),
        #     'name': 'noreward_small_frozen_lake',
        #     'readable_name': 'Frozen Lake (4x4)',
        # },
        # {
        #     'env': environments.get_large_no_reward_frozen_lake_environment(),
        #     'name': 'noreward_large_frozen_lake',
        #     'readable_name': 'Frozen Lake (15x15)',
        # },
    ]
